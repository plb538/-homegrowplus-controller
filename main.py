...
def poll(api):
    ...
    while True:
        ...
        try:
            ...
            val = sc.quantize(sc.readPin(api, drain_water_conductivity_sensor, "d"), 5)
            ...
            val = sc.quantize(sc.readPin(api, nutrient_conductivity_sensor, "d"), 5)
            ...
            val = sc.quantize(sc.readPin(api, acid_conductivity_sensor, "d"), 5)
            ...
            val = sc.quantize(sc.readPin(api, base_conductivity_sensor, "d"), 5)
            ...
            val = sc.quantize(sc.readPin(api, mixer_empty_conductivity_sensor, "d"), 5)
            ...
            val = sc.quantize(sc.readPin(api, mixer_full_conductivity_sensor, "d"), 5)
